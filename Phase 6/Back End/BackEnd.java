...
public class BackEnd{
    ...
    public static float StringToFloatFormat(String s){
    ...
    public static int findUser(String target, ArrayList<String> data){
    ...
    public static void saveToOutput(ArrayList<String> usersData, ArrayList<String> ticketData){
        try{
            ...
            System.out.println("Error: Failed to output file");
        }
    }
}